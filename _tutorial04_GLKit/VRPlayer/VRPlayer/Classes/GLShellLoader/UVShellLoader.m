...
+ (GLuint)loadSphereShadersWithVertexShaderString:(NSString*)vertexShaderString fragmentShaderString:(NSString*)fragmentShaderString andAttribLocations:(NSArray*)locations
{
    ...
    vertShaderPathname = [[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"Frameworks/VRPlayer.framework/VRPlayer.bundle/%@",vertexShaderString] ofType:@"vsh"];
    ...
    fragShaderPathname = [[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"Frameworks/VRPlayer.framework/VRPlayer.bundle/%@",fragmentShaderString] ofType:@"fsh"];
