...
- (id)initWithVertexFilepath:(NSString *)shaderFilename fragmentShaderFilename:(NSString *)fShaderFilename {
    ...
    NSString *vertShaderPathname = [[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"Frameworks/VRPlayer.framework/VRPlayer.bundle/%@",shaderFilename] ofType:@"vsh"];
    NSString *vertexShaderString = [NSString stringWithContentsOfFile:vertShaderPathname encoding:NSUTF8StringEncoding error:nil];
    
    NSString *fragShaderPathname = [[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"Frameworks/VRPlayer.framework/VRPlayer.bundle/%@",fShaderFilename] ofType:@"fsh"];
